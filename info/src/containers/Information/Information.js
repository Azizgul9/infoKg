        ...
        const categories = this.props.categories ? this.props.categories.map(category => {
            return (
                <div key={category._id} style={{position: 'relative'}}>
                    ...
                    {this.props.user &&
                    this.props.user.role === "azizgul@gmail.com" ?
            ...
            return (
                <div  key={item._id} className="RegionItem">
                    <div className="RegionItemBody">
                        {this.props.user && this.props.user.role === "azizgul@gmail.com" ?
                    ...
                    <Col sm={8}>
                        <div className="infoBlock">
                            <h5 className="infoText">
                                <strong>
                                    {this.state.categoryName ? this.state.categoryName.title : "Бардыгы"}
                                    </strong>
                            </h5>

                            {
                                ...
                                <Button color="success" >Жаңы маалмат кошуу</Button>
                                </Link> : null
                            }
                        </div>
                        <hr/>
